...
# === Compute Distance to Target (160, 0 mm) ===
target_x, target_y = 160, 0
...
axs[0].axhline(y=160, color='red', linestyle=':', linewidth=1.5, label='Target X = 160 mm')
...
axs[1].axhline(y=0, color='red', linestyle=':', linewidth=1.5, label='Target Y = 0 mm')
...
axs[2].set_ylabel("Distance to [160, 0] (mm)")
